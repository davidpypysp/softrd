...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/lib/${importLibraryName}")
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/bin/${sharedLibraryName}" )
  else()
    ...
    set_property(TARGET assimp::assimp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_RELEASE "/usr/lib/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/lib/${staticLibraryName}")
  endif()
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    if(WIN32)
      ...
      set(sharedLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}.so.a")
    elseif(APPLE)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE "/usr/lib/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/lib/${sharedLibraryName}" )
  else()
...
get_filename_component(ASSIMP_ROOT_DIR "/" REALPATH)

set( ASSIMP_CXX_FLAGS ) # dynamically linked library
set( ASSIMP_LINK_FLAGS "" )
set( ASSIMP_LIBRARY_DIRS "${ASSIMP_ROOT_DIR}/usr/lib")
