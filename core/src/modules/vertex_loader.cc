...
VertexLoader::VertexLoader(std::vector<Vertex>* vertex_buffer,
                           std::vector<uint32_t>* element_buffer)
    : vertex_buffer_(vertex_buffer), element_buffer_(element_buffer) {}

void VertexLoader::Setup(std::vector<Vertex>* vertex_buffer,
                         std::vector<uint32_t>* element_buffer) {
...
void VertexLoader::LoadCube() {
  math::vec3 cube_positions[] = {
      math::vec3(0.5, -0.5, 0.0),  math::vec3(0.5, 0.5, 0.0),
      math::vec3(-0.5, 0.5, 0.0),  math::vec3(-0.5, -0.5, 0.0),

      math::vec3(0.5, -0.5, -1.0), math::vec3(0.5, 0.5, -1.0),
      math::vec3(-0.5, 0.5, -1.0), math::vec3(-0.5, -0.5, -1.0),
  };

  math::vec2 cube_uvs[] = {math::vec2(1.0, 1.0), math::vec2(1.0, 0.0),
