...
RenderingPipeline::RenderingPipeline(const int width, const int height) : width_(width),
                                                                          height_(height),
...
void RenderingPipeline::SetShader(VertexShader *vertex_shader, FragmentShader *fragment_shader) {
...
void RenderingPipeline::SetPolygonMode(const Rasterizer::DrawTriangleMode mode) {
    polygon_mode_ = mode;
}
